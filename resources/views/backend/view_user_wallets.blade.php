@php 
$pageTitle = "View User Wallet Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">View User Wallet</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $each_wallet->system_wallet->wallet_name }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown ml-auto ">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="{{ route('edit-user-wallet', $each_wallet->unique_id ) }}">Edit Address</a>
                                                            </div>
                                                        </div>
                                                    </td>												
                                                </tr> 
                    ...
                    <div class="modal-body">
                        <div class="row"> 
                            ...
                            <div class="col-lg-12 mt-2">
                                <form action="{{ route('delete-user-wallet') }}" method="POST">
                                    @csrf
