            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Add User Wallet</a></li>
					</ol>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row m-b-30">
                                    <div class="col-lg-6 offset-lg-3">
                                        <h3 class="text-primary text-center m-2">Add User Wallet</h3>
                                        <!-- Validation Errors -->
                                        <x-auth-validation-errors class="mb-4 text-center text-danger" :errors="$errors" />
                                        <form action="{{ route('add-user-wallet') }}" method="POST">
                                            @csrf
                                            <div class="form-row">
