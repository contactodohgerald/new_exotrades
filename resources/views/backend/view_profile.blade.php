@php 
$pageTitle = "View User Profile Page";
@endphp
...
<body>
    ...
    ********************-->
    @include('includes.header')
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 mb-2 text-center">
                        <button class="btn btn-danger"  data-toggle="modal" data-target="#topUpFunds">Top Up Accounts</button>
                    </div>
				</div>
                <div class="row">
                    <div class="col-xl-12">
        ...
        ***********************************-->
        <!-- Modal -->
        <div class="modal fade" id="topUpFunds">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Top Up User Account</h5>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                    </div>
                    <form action="{{ route('top-up-account', $user->unique_id) }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-2 text-center">
                                    <button class="btn btn-primary" type="submit">Proceed With Request</button>
                                </div>
                            </div>
                        </div>
                    </form>
