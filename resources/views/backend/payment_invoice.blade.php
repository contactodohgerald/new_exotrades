            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Payment Invoice</a></li>
					</ol>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h3 class="text-center">Deposit Invoice - <b>{{ $invest->unique_id  }}</b> </h3>  
                                    <hr>   
                                </div>
                                <div class="col-lg-12">
                                    <p class="text-center"> 
                                        <small>
                                            ...
                                            <span style="font-size: 30px;"> 
                                                <strong>Amount ${{ number_format($invest->amount)  }}</strong>
                                            </span>
                                        </small>
                                    </p>
                                    <hr>   
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-center mb-3">
                                                <p class="mb-2"><b>{{ $invest->system_wallet->wallet_name }} Wallet To Pay To:</b></p>
                                                <span>
                                                    <input readonly type="text" value="{{ $invest->system_wallet->wallet_address }}" class="form-control" id="copyWallet">
                                                    <button class="btn btn-dark" onclick="processWalletCopy()">Copy & Paste Wallet</button>
                                                </span>
                                            </div> 
                                        </div>      
                                        @if($invest->system_wallet->wallet_name  == "BITCOIN")                               
                                        <h3 class="text-center">
                                            <span>Amount ${{ number_format($invest->amount)  }}</span>
                                            <br>
                                            <img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=bitcoin:{{ $invest->system_wallet->wallet_address }}?amount=<?php echo sprintf('%.08f', $invest->amount);?>"> 
                                        </h3>
                                        @endif
                                        <div class="alert alert-danger">
                                            @if($invest->system_wallet->wallet_name == "USDT")
                                            ...
                                            <hr>
                                            @endif
                                            <h3 class="text-center">Do not make payment to anyone or any {{ $invest->system_wallet->wallet_name  }} wallet address that isn't the one provided above on your dashboard.</h3>
                                        <p>&nbsp;</p>
                                        </div>
                                        
                                        
                                        <h4 class="text-center">
                                            <strong>====== How to pay with {{ $invest->system_wallet->wallet_name  }} =====</strong>
                                        </h4>
                                        <ol>
                                            <li><strong>Get a Wallet:</strong>&nbsp;First you'll need a {{ $invest->system_wallet->wallet_name  }} wallet - an app that lets you receive, hold, and spend {{ $invest->system_wallet->wallet_name  }}.</li>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form action="{{ route('upload-payment-proof', $invest->unique_id ) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="col-lg-12">
                                    <div class="mt-3 pb-3 text-center">
                                        <strong> 
                                            ...
                                            <br>
                                            <span class="h2 Pending">{{ $invest->received_status }}</span> 
                                        </strong>
                                        <hr>
                                    </div>
                                </div>
