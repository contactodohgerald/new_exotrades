            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Access Funds</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
							<div class="card-header d-block d-sm-flex border-0 pb-0">
								<div>
									<h4 class="text-black fs-20">Portfolio Value</h4>
                                    <hr>
								</div>
							</div>
							<div class="card-body">
										...
										<div class="card-bx bg-dark">
											...
											<div class="card-info text-white">
												<div class="d-flex align-items-center mb-3">
													...
													<p class="mb-0">Portfolio Total Value</p>
												</div>
												<div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <p class="fs-10 mb-2">Portfolio Total Value</p>
                                                            <h3 class="text-white">$ {{ number_format($accountRecovery->portifolio_value)}} </h3>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Acess Funds</h5>
                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                    </div>
                     <form action="{{ route('process/funds/access', $accountRecovery->unique_id) }}" method="POST">
                         @csrf
                        <div class="modal-body">
                            <div class="row"> 
                                <div class="col-lg-12 text-center">
                                    <p class="m-0">Portfolio Total Value</p>
                                    <h1 class="m-0">${{ number_format($accountRecovery->portifolio_value)}}</h1>
                                </div>
                                <div class="col-lg-12">
                                    <p class="alert alert-danger text-center" style="font-size: 14px">
                                        <b><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></b> 
                                        @php $cal = ($accountRecovery->portifolio_value * 5) / 100;  @endphp
                                        5% ($ {{number_format($cal)}}) traders fee is required to enable access to your funds
                                    </p>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="system_wallet_id">Select Wallet Address</label>
                                        <select name="system_wallet_id" id="system_wallet_id" class="form-control" required>
                                    ...
                                    <input type="hidden" value="{{$cal}}" name="amount">
                                </div>
