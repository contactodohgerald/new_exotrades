@php 
$pageTitle = "Emergency Cashout Page";
@endphp
...
<body>
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Emergency Cashout</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Emergency Cashout</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-stripped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Withdraw Investment</th>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-warning" onclick="brinOutWithdrawModal('{{$each_invest->unique_id }}')">Withdraw</button>
                                                    </td>	
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Withdraw From Plan</h5>
                    ...
                    <div class="modal-body">
                        <div class="row"> 
                            ...
                            <div class="col-lg-12 mt-2" id="withdrawUrlId">
    ...
    ***********************************-->
    ...
    <script>
        function brinOutWithdrawModal(invest_id) {
            let dataHold = '';
            dataHold += `<a href="investment_withdraw/${invest_id}" class="btn btn-primary" type="submit">Procced</a>`
            $("#withdrawUrlId").html(dataHold)
            $('#withdraw').modal('show')
        }
    </script>
