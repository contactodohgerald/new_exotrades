            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Upgraded Investment Payout</a></li>
                                                ...
                                                <div class="card-body p-4">
                                                    <div class="media align-items-center text-center">
                                                        <div class="media-body">
                                                            <h5 class="text-white fs-20">{{ $withdraw->users->name }}'s Account Balance:</h5>
                                                            <h1 class="text-white mb-0">$ {{ number_format($withdraw->users->main_balance) }}</h1>
                                                        </div>
