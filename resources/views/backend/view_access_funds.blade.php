@php 
$pageTitle = "Access Funds Request Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Access Funds Request History</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Confirm Access Funds Request</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            @if (count($accountRecoveryTwo) > 0)
                                            @php $counter = 1; @endphp
                                                @foreach ($accountRecoveryTwo as $each_recovery)
                                                <tr>	
                                                    <td class="text-center">{{ $counter }}</td>
                                                    <td class="text-center">{{ ($each_recovery->users == null)? 'None' : $each_recovery->users->email }}</td>
                                                    <td class="text-center">USD {{ number_format($each_recovery->trader_fee) }}</td>
                                                    <td class="text-center">
                                                        <button class="btn btn-warning shadow btn-xs" onclick="viewRecoveryProof('{{$each_recovery->payment_proof }}')">Proof</button>
                                                    </td>	
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown ml-auto ">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('funds/access/payment', $each_recovery->unique_id ) }}">Edit Investment</a>
                                ...
                                <div class="card-footer text-right">
                                    {{ $accountRecoveryTwo->render("pagination::bootstrap-4") }}                    
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Access Funds History</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                    ...
                    <div class="modal-body">
                        <div class="row"> 
                            ...
                            <div class="col-lg-12 mt-2">
                                <form action="{{ route('delete/fund/transfer/request') }}" method="POST">
                                    @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row"> 
                            ...
                            <div class="col-lg-12 mt-2">
                                <form action="{{ route('approve/fund/transfer/request') }}" method="POST"> @csrf
