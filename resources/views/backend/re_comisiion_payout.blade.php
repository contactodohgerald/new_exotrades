@php 
$pageTitle = "Referral Bonus Payout Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Referral Bonus Payouts</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Referral Bonus Payouts</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('ref-comission-payout-processor', $each_withdraw->unique_id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-money"></i></a>					
                                                    </td>												
                                                </tr> 
                                                @php $counter++ @endphp    
                                                @endforeach
