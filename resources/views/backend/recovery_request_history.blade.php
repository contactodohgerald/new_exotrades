@php 
$pageTitle = "Recovery Request History Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Recovery Request History</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Confirm Fund Transfer Request</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>	
                                                    ...
                                                    <td class="text-center">USD {{ number_format($each_recovery->service_charge) }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown ml-auto ">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('make/service/charge/payment', $each_recovery->unique_id ) }}">Edit Investment</a>
