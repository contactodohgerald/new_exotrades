            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Access Funds</a></li>
						<li class="breadcrumb-item"><a href="javascript:void(0)">Trader Fee </a></li>
					</ol>
                </div>
                <div class="container">
                    <div class="row">
                                    ...
                                    <p class="text-center"> 
                                        <small>
                                            ...
                                            <span style="font-size: 30px;"> 
                                                <strong>Amount ${{ number_format($accountRecovery->trader_fee)  }}</strong>
                                            </span>
                                        </small>
                                    </p>
                                    <hr>   
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        ...
                                        <h3 class="text-center">
                                            <span>Amount ${{ number_format($accountRecovery->trader_fee)  }}</span>
                                            <br>
                                            <img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=bitcoin:{{ $accountRecovery->system_wallet->wallet_address }}?amount=<?php echo sprintf('%.08f', $accountRecovery->trader_fee);?>"> 
                                        </h3>
                                        @endif
