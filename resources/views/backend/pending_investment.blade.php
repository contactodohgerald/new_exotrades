@php 
$pageTitle = "Pending Investment History Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Pending Investment History</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pending Investment History</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $each_invest->system_wallet->wallet_name }}</td>
