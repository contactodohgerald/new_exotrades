@php 
$pageTitle = "Crypto Purchase History Page";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Crypto Purchase History</a></li>
					</ol>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Crypto Purchase History</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-stripped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Bought Coin Value</th>
                                        ...
                                        <tbody>
                                            ...
                                            @php $counter = 1; @endphp
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{($each_invest->amount_to_buy / $each_invest->coin_details->currrent_price)}}</td>
                                                    <td class="text-center">{{ $each_invest->system_wallet->wallet_name }} Transfer</td>
