@php 
$pageTitle = "Service Charge Invoice";
@endphp
            ...
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Portfolio Recovery
</a></li>
						<li class="breadcrumb-item"><a href="javascript:void(0)">Fund Transfer</a></li>
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Service Charge</a></li>
					</ol>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h3 class="text-center">Transaction ID - <b>{{ $accountRecovery->unique_id  }}</b> </h3>  
                                    <hr>   
                                </div>
                                <div class="col-lg-12">
                                    <p class="text-center"> 
                                        <small>
                                            ...
                                            <span style="font-size: 30px;"> 
                                                <strong>Amount ${{ number_format($accountRecovery->service_charge)  }}</strong>
                                            </span>
                                        </small>
                                    </p>
                                    <hr>   
                                ...
                                <div class="col-lg-12">
                                    <div class="">
                                        ...
                                        <h3 class="text-center">
                                            <span>Amount ${{ number_format($accountRecovery->service_charge)  }}</span>
                                            <br>
                                            <img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl=bitcoin:{{ $accountRecovery->system_wallet->wallet_address }}?amount=<?php echo sprintf('%.08f', $accountRecovery->service_charge);?>"> 
                                        </h3>
                                        @endif
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form action="{{ route('upload/trader/fee/proof', $accountRecovery->unique_id ) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
