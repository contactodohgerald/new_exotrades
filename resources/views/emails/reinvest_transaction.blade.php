            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Dear {{$userDetails->name}}, Your request to upgrade/reinvest your current investment plan was created successful.</p>
                        <p>Proceed to make payments/deposit to the wallet below. Please you are directed to make payment within 24hours of creating this request.</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <strong>{{$investment->system_wallet->wallet_name}} Address: </strong> {{$investment->system_wallet->wallet_address}},<br />
