            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Withdrawal Notification</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <p>{{$userDetails->name}} have successfully Placed a withdrawal request from his wallet on {{ucfirst($settings->site_name)}}..</p>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <strong>{{$wallet_type}} Wallet: </strong>{{$user_wallet}},<br />
                        <strong>Date Created:: </strong>{{$transactions->created_at}},<br />
                        <strong>Transaction ID:: </strong>{{$transactions->unique_id}},<br /><br>
                        <p>Please note that this request needs authorization from the Admin before money will be sent to users wallet. Visit the withdrawal section of your website for more details.</p>
                    </td>
                </tr>
                <!-- end copy -->
