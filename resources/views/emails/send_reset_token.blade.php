...
<head>
    ...
    <title>Token For Password Reset On {{ucfirst($settings->site_name)}}</title>
...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Token For Password Reset On {{ucfirst($settings->site_name)}}
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h3 style="margin: 0;  line-height: 28px; text-align:center">Token For Password Reset On {{ucfirst($settings->site_name)}}</h3>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td align="center" bgcolor="#D2C7BA">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">To reset the password to your {{ucfirst($settings->site_name)}} account, provide the {{$settings->verification_token_length}} digit token below to proceed</p>
                    </td>
                </tr>
                <!-- end copy -->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#f05a23" style="border-radius: 6px;">
                                                <h1 style="padding: 10px 40px"><b>{{$code}}</b></h1>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
