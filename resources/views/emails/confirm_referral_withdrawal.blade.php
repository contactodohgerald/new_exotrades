...
<head>
    ...
    <title>{{ucfirst($settings->site_name)}} - Referral Bonus Payment Notification</title>
...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   {{ucfirst($settings->site_name)}} - Referral Bonus Payment Notification
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Referral Bonus Payment Notification</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p>Payment for your referral bonus withdrawal request have been approved and sent to your Wallet/Account Details.</p>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <strong>Current Wallet Balance: </strong> {{number_format($ref_comission->users->ref_bonus_balance)}},<br />
