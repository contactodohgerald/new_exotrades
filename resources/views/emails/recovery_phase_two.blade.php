    ...
    <tr>
        <td align="center" bgcolor="#D2C7BA">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <P style="margin: 0;">This is to inform you that the portfolio with account ID {{$user->payment->recovery->account_id}} valued at (<b>USD ({{number_format($user->payment->recovery->portifolio_value)}})) has been transferred successfully to your account </P> 
                        <p style="margin: 0;">Kindly note that for withdrawal you will be charged 5% traders fee of your portfolio  total value (<b>USD ({{number_format($user->payment->recovery->portifolio_value)}}))</p>
                    </td>
                </tr>
                <!-- end copy -->
