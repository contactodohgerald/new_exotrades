...
<head>
    ...
    <title>{{ucfirst($settings->site_name)}} - Withdrawal Notification</title>
...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   {{ucfirst($settings->site_name)}} - Withdrawal Notification.
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Investment Withdrawal Notification</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <p>You have successfully placed an order to withdraw the sum of {{number_format($investment->amount)}} from your current/active investment. </p>
                        <p>You Investment is still active and it's unwise to place/intiate a withdrawal at this time. <br><b>Note!</b> A service fee of <b>{{$settings->withdrawal_penalty}}%</b> will be charged for this request</p>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <p>Payment will be sent the wallet listed below::</p>
                        <strong>{{$transactions->user_wallet->system_wallet->wallet_name}} Wallet: </strong>{{$transactions->user_wallet->wallet_address }},<br />
                    </td>
                </tr>
                <!-- end copy -->
