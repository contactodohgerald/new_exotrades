...
<head>
    ...
    <title>{{ucfirst($settings->site_name)}} - Payment Notification</title>
...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   {{ucfirst($settings->site_name)}} - Payment Notification.
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Payment Notification</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Hi {{$userDetails->name}} ,</p>
                        <p>Payment for your withdrawal Request have been approved and sent to your Wallet/Account Details.</p>
                        <p>Details of Request is listed below:</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <strong>Amount: </strong> {{number_format($transactions->amount)}},<br />
                        <strong>Current Wallet Balance: </strong> {{number_format($userDetails->main_balance)}},<br />
                        <strong>Date Created:: </strong>{{$transactions->created_at}},<br />
                        <strong>Transaction ID:: </strong>{{$transactions->unique_id}},<br /><br>
                        <p>Payment have been sent to your Wallet/Account Details listed below:</p>
                        <strong>{{$user_wallet->system_wallet->wallet_name}} Wallet: </strong>{{$user_wallet->wallet_address}}
                    </td>
                </tr>
                <!-- end copy -->
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="#f05a23" style="border-radius: 6px;">
                                                <h3 style="padding: 2px 5px;">
                                                    <a style="color:#fff" href="{{ $settings->site_domain }}login">Visit Website</a>
                                                </h3>
                                            </td>
                                        </tr>
                                    </table>
