...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Successfull Password Reset On {{$date_format}}.
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h3 style="margin: 0;  line-height: 28px; text-align:center">Successfull Password Reset on {{$date_format}}.</h3>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td align="center" bgcolor="#D2C7BA">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Dear <b>{{$userDetails->name}}</b></p>
                        <p style="margin: 0;">You recieved this mail, because on the {{$date_format}} you placed request to reset your password.  Login to your {{ucfirst($settings->site_name)}} account to explore our awesome features</p>
                    </td>
                </tr>
                <!-- end copy -->
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                       <p style="margin: 0;">If you did not initiate this request on your {{ucfirst($settings->site_name)}} account, kindly contact {{ucfirst($settings->site_name)}} (our 24/7 Live Support) or send an email to <a href="mailto::{{$settings->site_email}}">{{$settings->site_email}}</a>, stating your name and email.</p>
                    </td>
                </tr>
