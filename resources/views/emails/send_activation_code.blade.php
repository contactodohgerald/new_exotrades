    ...
    <tr>
        <td align="center" bgcolor="#D2C7BA">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Your have successfully created an account with {{ucfirst($settings->site_name)}}, Below is a {{$settings->verification_token_length}} digit code for the activation of your account. please provide this code to proceed</p>
                        <p style="margin: 0;">Thanks for being part of the {{ucfirst($settings->site_name)}} family.</p>
                    </td>
                </tr>
                <!-- end copy -->
