...
<head>
    ...
    <title>{{ucfirst($user->settings->site_name)}} - Recovery Link</title>
...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    {{ucfirst($user->settings->site_name)}} - Recovery Link
</div>
<!-- end preheader -->
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 36px 24px;">
                        <a href="{{$user->settings->site_domain}}" target="_blank" style="display: inline-block;">
                            <img src="{{$user->settings->site_logo_url}}" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
                        </a>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">{{ucfirst($user->settings->site_name)}} - Recovery Link</h2>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td align="center" bgcolor="#D2C7BA">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <P style="margin: 0;">Kindly click on the button below to retrieve your account ID</p>
                    </td>
                </tr>
                <!-- end copy -->
                <!-- start button -->
                            ...
                            <tr>
                                <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#6418C3" style="border-radius: 6px;">
                                                <h3 style="padding: 2px 5px;">
                                                    <a style="color:#fff" href="{{ $user->link }}">Retrieve Account</a>
                                                </h3>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <P style="margin: 0;">If the link above is not clickable, copy and paste the link below to your browser</p>
                    </td>
                </tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#f05a23" style="border-radius: 6px;">
                                                <h3 style="padding: 2px 5px;">
                                                    <a style="color:#fff" href="{{ $user->settings->site_domain }}login">Visit Website</a>
                                                </h3>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px; border-bottom: 5px solid #1b1363">
                        <p style="margin: 0;">Thanks and Regards {{ucfirst($user->settings->site_name)}}.</p>
                    </td>
                </tr>
                <!-- end copy -->
