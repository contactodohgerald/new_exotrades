...
<head>
    ...
    <title>Crypto Purchase Payment</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Crypto Purchase Payment</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Dear {{$userDetails->name}}, the total of ${{number_format($investment->amount_to_pay)}} was paid to your main balance on {{$date_format}} for the ${{number_format($investment->amount_to_buy)}} worth of {{$investment->coin_details->coin_name}} you bougth. <br> If you have any question about this mail, kindly send an email to <a href="mailto::{{$settings->site_email}}">{{$settings->site_email}}</a> or chat our 24/7 live support team</p>
                    </td>
                </tr>
                <!-- start button -->
                <tr>
