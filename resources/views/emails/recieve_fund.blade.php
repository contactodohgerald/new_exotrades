            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p>Your account has been credited with the total sum of {{number_format($transactions->amount)}} from {{$sender->name}}</p>
                    </td>
                </tr>
                <!-- end copy -->
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <strong>Sender Name: </strong>{{$sender->name}},<br />
                        <strong>Amount Recieved: </strong> {{number_format($transactions->amount)}},<br />
