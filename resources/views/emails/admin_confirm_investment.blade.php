            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">Dear Admin </p>
                        <p>You successfully comfirmed this user's {{$userDetails->name}} transaction, this means that you have confirmed that $ {{number_format($investment->amount)}} was sent to. Below are the details of the transaction.</p>
                    </td>
                </tr>
                <tr>
