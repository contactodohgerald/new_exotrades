            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p>You have successfully created a referral withdrawal request from your referral bonus wallet on {{ucfirst($settings->site_name)}}</p>
                        <p>Payment is now being processed. You will be notified once payment is sent to your wallet</p>
