...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   {{ucfirst($settings->site_name)}} - Referral Withdrawal Notification
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h2 style="margin: 0;  line-height: 28px; text-align:center">Referral Withdrawal Notifier</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p>{{$userDetails->name}} have successfully created a referral withdrawal request from his referral bonus wallet on {{ucfirst($settings->site_name)}}</p>
                        <p>Details of Request is listed below:</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 18px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <strong>Amount: </strong> {{number_format($ref_comission->amount)}},<br />
                        <strong>Date Created:: </strong>{{$ref_comission->created_at}},<br />
                        <strong>Transaction ID:: </strong>{{$ref_comission->unique_id}},<br /><br>
                        <p>Please note that this request needs authorization from the Super-Admin before money will be sent to users wallet. Visit the Referral Comission Payout section of your website for more details.</p>
                    </td>
                </tr>
                <!-- end copy -->
