...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    {{ucfirst($settings->site_name)}} LOGIN ALERT ON {{$date_format}}.
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Merriweather Bold', serif; border-top: 5px solid #1b1363;">
                        <h3 style="margin: 0;  line-height: 28px; text-align:center">{{ucfirst($settings->site_name)}} LOGIN ALERT ON {{$date_format}}.</h3>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">{{ucfirst($settings->site_name)}} Login Notification</p>
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;">Dear <b>{{$userDetails->name}}</b></p>
                        <p style="margin: 0;">There was a successful login to your {{ucfirst($settings->site_name)}} Account</p>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                       <p style="margin: 0;">If you did not login to your {{ucfirst($settings->site_name)}} account, kindly contact {{ucfirst($settings->site_name)}} (our 24/7 Live Support) or send an email to <a href="mailto::{{$settings->site_email}}">{{$settings->site_email}}</a>, stating your name and email.</p>
                    </td>
                </tr>
