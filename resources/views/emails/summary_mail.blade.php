            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
                        ...
                        <strong>Amount Invested: </strong> {{number_format($investment->amount)}},<br />
                        <strong>Investment Plan: </strong>{{$investment->plans->plan_name}},<br />
                        ...
                        <strong>Currency: </strong>{{$investment->coin_type}}<br />
                    </td>
                </tr>
                <tr>
                    <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Merriweather', serif; font-size: 16px; line-height: 24px;">
